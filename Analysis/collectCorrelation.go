...
func ProcessLogBatch(inputFile string, distance int) error {
	...
	// batchStartIDs := []int{20499866, 20500000}
	// batchEndIDs := []int{20499999, 20500100}
	batchStartIDs := []int{20759722, 21009722, 21259723}
...
func FixFirstBatch(inputFile string, distance int) error {
	...
	// batchStartIDs := []int{20499866, 20500000}
	// batchEndIDs := []int{20499999, 20500100}
	batchStartIDs := []int{20759722}
	batchEndIDs := []int{21009721}
	var batchIndex int
	batchIndex = 0
...
func main() {
	...
	// rerun the first two batches under dist=0
	err := ProcessLog1(logFile1, 0)
	if err != nil {
		fmt.Println("Error:", err)
	}

	err = FixFirstBatch(logFile2, 0)
	if err != nil {
		fmt.Println("Error:", err)
	}
