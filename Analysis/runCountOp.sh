...
PATH_TO_WITH_CACHE=/mnt/ssd/geth-trace-withcache-merged-block-20500000-21500000
...
if [ "$target" == "without" ]; then
    ...
    for i in {10..10}; do
        ...
        ./countOpDistributionSingle $PATH_TO_WITH_CACHE 50000 10000 20500000 21500000
